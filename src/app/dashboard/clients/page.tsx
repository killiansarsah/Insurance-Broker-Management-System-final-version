            ...
            {showFilters && (
                <div className="bg-white rounded-2xl border border-surface-200/60 shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
                        <div>
                            <label className="block text-[11px] font-semibold text-surface-500 uppercase tracking-wider mb-2">Status</label>
                            <select
                                value={filterStatus}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold text-surface-500 uppercase tracking-wider mb-2">KYC Status</label>
                            <select
                                value={filterKyc}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold text-surface-500 uppercase tracking-wider mb-2">AML Risk</label>
                            <select
                                value={filterRisk}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold text-surface-500 uppercase tracking-wider mb-2">Client Type</label>
                            <select
                                value={filterType}
