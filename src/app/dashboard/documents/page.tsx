            ...
            <Card padding="md" className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="px-3 py-2 text-xs font-medium bg-surface-50 border border-surface-200 rounded-[var(--radius-md)] focus:outline-none focus:ring-2 focus:ring-primary-500/20"
                    >
                        <option value="all">All Categories</option>
                        <option value="kyc">KYC / ID</option>
                        <option value="policy">Policy Docs</option>
                        <option value="claims">Claim Photos</option>
                    </select>
                </div>
            </Card>
