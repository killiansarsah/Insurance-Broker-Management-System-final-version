...
function SelectSetting({ label, desc, icon, options }: any) {
    return (
        <div className="space-y-3">
            ...
            <select className="w-full px-4 py-2.5 bg-surface-50 border border-surface-200 rounded-xl text-sm font-bold focus:ring-4 focus:ring-accent-500/10 focus:border-accent-500 outline-none transition-all appearance-none cursor-pointer">
