...
export const MOCK_CHATS: ChatConversation[] = [
    ...
    },
    {
        ...
        participantName: 'Ama Serwaa',
        participantAvatar: undefined,
        participantRole: 'Branch Manager',
        lastMessage: 'Got the approval for the Osei policy.',
    ...
    },
    {
        ...
        participantName: 'Kofi Adom',
        participantAvatar: undefined,
        participantRole: 'Senior Broker',
        lastMessage: 'Checking the fire claim on CLM-084.',
        lastMessageTime: new Date(Date.now() - 86400000 * 10).toISOString(),
        unreadCount: 0,
        isOnline: false,
        type: 'direct',
        linkedResourceId: 'clm-084',
