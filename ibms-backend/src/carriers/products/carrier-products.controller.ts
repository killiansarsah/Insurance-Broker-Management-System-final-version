...
export class CarrierProductsController {
    ...
    create(@Request() req: any, @Param('carrierId') carrierId: string, @Body() createProductDto: CreateProductDto) {
    ...
    @Patch(':id')
    @Roles('ADMIN', 'TENANT_ADMIN')
    update(@Request() req: any, @Param('carrierId') carrierId: string, @Param('id') id: string, @Body() updateProductDto: UpdateProductDto) {
