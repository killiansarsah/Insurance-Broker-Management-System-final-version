...
export class CarriersService {
    ...
    async create(tenantId: string, userId: string, dto: CreateCarrierDto) {
        ...
        if (existing) {
            throw new BadRequestException(`Carrier with slug ${dto.slug} already exists for this tenant`);
        }
        ...
        await this.logAudit(tenantId, userId, 'carrier.created', carrier.id, null, carrier);
        return carrier;
    }
    ...
    async update(tenantId: string, userId: string, id: string, dto: UpdateCarrierDto) {
        ...
        await this.logAudit(tenantId, userId, 'carrier.updated', id, carrier, updated);
        return updated;
    }
}
