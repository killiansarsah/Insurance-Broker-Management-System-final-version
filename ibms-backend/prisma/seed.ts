...
async function main(): Promise<void> {
  ...
  // ─── CARRIERS & PRODUCTS ───────────────────────────
  // ════════════════════════════════════════════════════
  const carrierData: Array<{ name: string; shortName: string; slug: string; type: CarrierType; brandColor: string; website: string; licenseNumber: string }> = [
    ...
    { name: 'Africa Re', shortName: 'AFRICARE', slug: 'africa-re', type: CarrierType.REINSURER, brandColor: '#B45309', website: 'https://africa-re.com', licenseNumber: 'NIC/RE/001' },
  ];
