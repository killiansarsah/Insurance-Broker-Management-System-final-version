...
const EditPolicy: React.FC = () => {
  ...
  // Form State - Pre-filled with mock data for "Loretta Boakye"
  const [formData, setFormData] = useState({
    ...
    digitalAddress: 'GA-123-4567', // GhanaPost GPS
    origin: 'Ghanaian',
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Edit Policy</h1>
          </div>
          <p className="text-slate-500 font-medium text-lg ml-9">
            Updating Record: <span className="font-mono font-bold text-slate-700 dark:text-slate-300">GG-DSDM-1011-23-006822</span>
          </p>
        </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
              ...
              <div className="p-10 flex flex-col gap-8">
                ...
                <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                   <p className="text-xs font-bold text-slate-600 dark:text-slate-400 leading-relaxed italic">
                    By clicking "Save Changes", you confirm that the provided information is accurate and consistent with the physical files.
                   </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            >
              ...
              <span className="material-symbols-outlined text-lg ml-2">{currentStep === 5 ? 'save' : 'arrow_forward'}</span>
            </button>
          </div>
        </div>
