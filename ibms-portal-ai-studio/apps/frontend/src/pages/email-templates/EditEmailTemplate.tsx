...
import { getEmailTemplate, updateEmailTemplate } from '../../services/emailTemplateApi';
  ...
  const fetchTemplate = async () => {
    ...
    try {
      ...
      if (result && result.status === 200) {
        ...
        if (template.design) {
          try {
            const parsedDesign = typeof template.design === 'string' 
  ...
  if (loading) {
    return (
      <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" minHeight="400px">
        <CircularProgress size={48} sx={{ color: '#137fec', mb: 2 }} />
        <Typography variant="body1" color="text.secondary">Loading template...</Typography>
      </Box>
    );
  }
        ...
        <Stack direction="row" alignItems="center" spacing={3}>
          ...
          <Box flex={1}>
            ...
            <Typography variant="body1" sx={{ opacity: 0.95 }}>
              Modify your email template design and content
            </Typography>
          </Box>
        </Stack>
      </Card>
        ...
        <Stack direction="row" spacing={2} alignItems="flex-start">
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.7 }}>
              Your previous design has been loaded. Make any changes you need using the drag-and-drop editor.
              Click "Save Changes" when you're done to update the template with your modifications.
            </Typography>
          </Box>
        </Stack>
      </Card>
